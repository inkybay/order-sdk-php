...
-     Purpose       :   Action Sdk on inkybay Mate
-
...
class Action{
	...
	#	======Public functions start======::>
		...
		public function setHeaders($method,$apiService,$apiServiceAction='default'){
			...
			$this->setHeader('accessSign',$this->inkybayApiSignature($this->_config->accessKey,$this->_config->secretKey,$method,$tm,$apiService));
	...
	#	=======Private functions start======::>
		...
		private function inkybayApiSignature($accessKey,$secretKey,$method,$timeStamp,$apiService){			
			//$eSignKey 	= 'inkybay_API_' . $secretKey;
